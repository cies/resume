...
\\
\lettrine[lines=2,loversize=0.1,findent=-3pt]{A}{}\acr{AT THE AGE} of seven (1989) I wrote my first lines using a \acr{LOGO}-like language on an \acr{MSX} (pre-\acr{PC}). Two years later I attended a conference on an emerging new technology, the Internet, at the Erasmus University from which I would graduate 16 years later.
