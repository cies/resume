...
\vspace{-1.1em}
\begin{multicols}{2}
\emph{Creative software engineer with roots in the open source (\acr{FLOSS}) movement and a passion for user/customer centered software development.}
\\
\\
...
After graduation I traveled Europe and Asia during a two year sabbatical, I worked on several occasions (see experience below) and initiated an open source project (\href{http://www.truetopiaproject.org}{Truetopia}:\ a web application that facilitates self-governing online communities).
...
\begin{itemize} \parskip=0.1em
	...
	\subheaderrow
		...
		{2004 -- 2007}
  Focussed on the economics of open source, rapid application development and the semantic web technology stack (\acr{RDF}/\acr{RDFS}, \acr{OWL} and \acr{SPARQL}).
