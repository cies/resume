...
\\
\lettrine[lines=3,loversize=0.1]{A}{t the age} of seven (1989) I wrote my first lines using a \acr{LOGO}-like language on an \acr{MSX} (pre-\acr{PC}). Two years later I attended a conference on an emerging new technology, the Internet, at the Erasmus University from which I would graduate 16 years later.
